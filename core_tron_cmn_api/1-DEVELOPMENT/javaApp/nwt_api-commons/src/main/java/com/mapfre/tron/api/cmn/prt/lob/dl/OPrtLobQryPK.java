...
@Data 
@Builder
public class OPrtLobQryPK implements NewtronPK {
	...
	public static final OPrtLobQryPK get(OPrtLobS s) {
    		return OPrtLobQryPK.builder().lobVal(s.getLobVal()).cmpVal(s.getCmpVal())
