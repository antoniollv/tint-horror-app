...
package com.mapfre.tron.yaml.bl.impl;
...
public class BlWriterImpl implements IBlWriter {
     ...
     */
    @Override
    public void givingWritingDataToFile(final String filename, final List<SwaggerData> data) {
        ...
        if (data != null && !data.isEmpty()) {
            ...
            try (PrintWriter printWriter = new PrintWriter(new FileWriter(file)) ){
                ...
                printWriter.println("");
                infoContainer(data.get(0).getTitle(), printWriter);
                printWriter.println("");
                ...
                for (SwaggerData myData : data) {
                    ...
                    threatProtocol(printWriter, myData);
    ...
    protected void threatProtocol(PrintWriter printWriter, SwaggerData myData) {
        performProtocol(printWriter, myData.getProtocol().toUpperCase());
    }

    protected void performProtocol(PrintWriter printWriter, String protocol) {
        printWriter.println(String.format("\t\t\t\t\t\t\t\t\t\t<div class=\"opblock opblock-%s\">", protocol.toLowerCase()));
        printWriter.println(String.format("\t\t\t\t\t\t\t\t\t\t\t<div class=\"opblock-summary opblock-summary-%s\">", protocol.toLowerCase()));
        printWriter.println(String.format("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"opblock-summary-method\">%s</span>", protocol));
    }
