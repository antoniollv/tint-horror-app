...
/**
 * The PAsignaNUMBER DL procedure repository.
 *
 * @author BRCHARL
 * @since 1.8
...
@Slf4j
@Repository
public class PAsignaNUMBER extends StoredProcedure {
     ...
     */
    @Autowired
    public PAsignaNUMBER(@Qualifier("dsTwPr") DataSource ds) {
        super(ds, TRN_K_GLOBAL_P_ASIGNA);
        declareParameter(new SqlParameter("p_variable", Types.NVARCHAR));
        declareParameter(new SqlParameter("p_valor", Types.BIGINT));
     ...
     */
    public void asigna(final String pmVariable, final BigDecimal pmValor) {
