...
/**
 * The beneficiary types.
 *
 * @author pvraul1
 * @since 1.8
 * @version 2 sept. 2020 11:55:57
 *
 */
@Data
@Slf4j
@Controller
@Api(tags={ "Common",})
public class BeneficiaryTypesController implements BeneficiaryTypesApi {
    ...
    /**
     * Query beneficiary types. It will return the types of beneficiaries.
     *
     * @author pvraul1
     *
     ...
     * @return       -> The types of beneficiaries
     */
    @Override
    public ResponseEntity<List<OCmnTypP>> getBeneficiaryTypes(
        ...
        log.info("The getBeneficiaryTypes rest operation had been called...");

        try {
            String getNamTypVal = CTrn.GET_NAM_ALL;
            BigDecimal lobVal = CPrt.GNC_LOB_VAL;
            String fldNam = "TIP_BENEF";
