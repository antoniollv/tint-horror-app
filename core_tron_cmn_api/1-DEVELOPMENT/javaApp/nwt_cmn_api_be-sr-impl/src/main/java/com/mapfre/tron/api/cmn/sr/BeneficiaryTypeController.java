...
/**
 * The beneficiary type controller.
 *
 * @author pvraul1
 * @since 1.8
 * @version 2 sept. 2020 11:46:53
 *
 */
@Data
@Slf4j
@Controller
@Api(tags={ "Common",})
public class BeneficiaryTypeController implements BeneficiaryTypeApi {
    ...
    /**
     * Query beneficiary type. It will return the type of beneficiary.
     *
     * @author pvraul1
     *
     ...
     * @param valVal -> Value
     * @return       -> The type of beneficiary
     */
    @Override
    public ResponseEntity<OCmnTypS> getBeneficiaryType(
        ...
        log.info("The getBeneficiaryType rest operation had been called...");
