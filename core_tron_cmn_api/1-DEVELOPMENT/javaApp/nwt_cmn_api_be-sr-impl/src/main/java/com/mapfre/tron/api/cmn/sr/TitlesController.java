...
public class TitlesController implements TitlesApi {
    ...
    /**
     * Query titles. It will return the types of titles.
     *
     * @author pvraul1
     *
     ...
     * @return -> The types of titles
     */
    @Override
    public ResponseEntity<List<OCmnTypP>> getTitles(
        ...
        log.info("The getTitles rest operation had been called...");

        try {
            String getNamTypVal = CTrn.GET_NAM_ALL;
            BigDecimal lobVal = CPrt.GNC_LOB_VAL;
            String fldNam = "TIP_PREFIJO_NOMBRE";
