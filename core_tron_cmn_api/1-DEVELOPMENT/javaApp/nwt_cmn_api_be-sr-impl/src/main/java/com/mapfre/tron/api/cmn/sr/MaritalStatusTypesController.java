...
/**
 * The marital status types controller.
 *
 * @author pvraul1
 * @since 1.8
 * @version 2 sept. 2020 11:20:16
 *
 */
@Data
@Slf4j
@Controller
@Api(tags={ "Common",})
public class MaritalStatusTypesController implements MaritalStatusTypesApi {
    ...
    /**
     * Query marital status types. It will return the types of marital status.
     *
     * @author pvraul1
     *
     ...
     * @return       -> The types of marital status
     */
    @Override
    public ResponseEntity<List<OCmnTypP>> getMaritalStatus(
        ...
        log.info("The getMaritalStatus rest operation had been called...");
