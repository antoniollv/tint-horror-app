...
@AllArgsConstructor
@NoArgsConstructor
public class TwVldMakImpl implements IVldMak {
     ...
     */
    @Override
    public OTrnErrS vldMak(BigDecimal cmpVal, String lngVal, Date vldDat, BigDecimal makVal) {

	try {
	    int rows = iDlMdlDAO.count(cmpVal, lngVal, vldDat, makVal);
	    if (rows > 0) {
		return null;
	    }
	 ...
	 return dlTrnErr.getError(new BigDecimal(ERROR_CODE), lngVal, "MAK", "MAK_VAL", cmpVal);
