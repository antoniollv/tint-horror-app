...
/**
 * The tronweb system information business logic implementation service.
 *
 * @author arquitectura - pvraul1
 * @since 1.8
 * @version 23 nov. 2020 - 8:53:53
 *
 */
@Data
@Slf4j
@TronWebAccess
public class TwBlSysInfImpl implements IBlSysInf {
    ...
    public About getAboutQuery(Integer cmpVal, String usrVal, String lngVal) {
        ...
        // setting profile
        lvAbout.setProfile("TronWebAccess");
